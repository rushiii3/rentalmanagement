        ...
        <div class="shadow p-4 rounded-lg bg-white dark:bg-gray-900 	 ">
          ...
          <div class="grid grid-cols-2 grid-rows-2 gap-4 mt-8">
            <p class="inline-flex flex-col xl:flex-row xl:items-center text-gray-800">
              ...
              <span class="mt-2 xl:mt-0 dark:text-white">Condominium</span>
            </p>
            <p class="inline-flex flex-col xl:flex-row xl:items-center text-gray-800 ">
              <svg
                class="inline-block w-5 h-5 xl:w-4 xl:h-4 mr-3 fill-current text-gray-800 dark:text-white"
              ...
              <span class="mt-2 xl:mt-0 dark:text-white">Partly furnished</span>
            </p>
            <p class="inline-flex flex-col xl:flex-row xl:items-center text-gray-800">
              <svg
                class="inline-block w-5 h-5 xl:w-4 xl:h-4 mr-3 fill-current text-gray-800 dark:text-white"
              ...
              <span class="mt-2 xl:mt-0 dark:text-white">1,386 sq. ft.</span>
            </p>
            <p class="inline-flex flex-col xl:flex-row xl:items-center text-gray-800">
              <svg
                class="inline-block w-5 h-5 xl:w-4 xl:h-4 mr-3 fill-current text-gray-800 dark:text-white"
              ...
              <span class="mt-2 xl:mt-0 dark:text-white">$1.98 /sq.ft</span>
            </p>
          </div>
          ...
          <div class="grid grid-cols-2 mt-8">
            <div class="flex items-center">
              ...
              <p class="ml-2 text-gray-800 line-clamp-1 dark:text-white">John Doe</p>
            </div>
