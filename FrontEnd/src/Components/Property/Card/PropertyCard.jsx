  ...
  return (
    <div className="relative mx-auto w-full px-1">
      <Link className="relative inline-block duration-300 ease-in-out transition-transform transform hover:-translate-y-2 w-full ">
        <div className="shadow p-4 rounded-lg bg-white dark:bg-gray-900 	 ">
          ...
          <div className="mt-4">
            <h2
              className="font-medium text-base md:text-lg text-gray-800 line-clamp-1 dark:text-white"
              title="New York"
            >
              {property.property_bhk_type} House in {property.building_name}, {property.property_locality}
            </h2>
            <p
              className="mt-2 text-sm text-gray-800 line-clamp-1 dark:text-white"
          ...
          <div className="grid grid-cols-2 grid-rows-2 gap-4 mt-8">
            <p className="inline-flex flex-col xl:flex-row xl:items-center text-gray-800">
              ...
              <span className="mt-2 xl:mt-0 dark:text-white">{property.property_type}</span>
            </p>
            <p className="inline-flex flex-col xl:flex-row xl:items-center text-gray-800 ">
              <svg
                className="inline-block w-5 h-5 xl:w-4 xl:h-4 mr-3 fill-current text-gray-800 dark:text-white"
              ...
              <span className="mt-2 xl:mt-0 dark:text-white">{property.property_furnishing}</span>
            </p>
            <p className="inline-flex flex-col xl:flex-row xl:items-center text-gray-800">
              <svg
                className="inline-block w-5 h-5 xl:w-4 xl:h-4 mr-3 fill-current text-gray-800 dark:text-white"
              ...
              <span className="mt-2 xl:mt-0 dark:text-white">{property.property_size} sq. ft.</span>
            </p>
            ...
            <svg
              ...
              <span className="mt-2 xl:mt-0 dark:text-white">{property.property_parking}</span>
            </p>
          ...
          <div className="grid grid-cols-2 mt-8">
            <div className="flex items-center">
              ...
              <p className="ml-2 text-gray-800 line-clamp-1 dark:text-white">
            ...
            <div className="flex justify-end">
              <p className="inline-block font-semibold text-primary whitespace-nowrap leading-tight rounded-xl">
                ...
                <span className="text-lg">{property.property_rent_price}</span>/m
              </p>
            </div>
          </div>
        </div>
