...
const PropertyCard = ({ property }) => {
  return (
    <div className="relative mx-auto w-full px-1">
      <Link to={`/properties/${property.id}`} className="relative inline-block duration-300 ease-in-out transition-transform transform hover:-translate-y-2 w-full ">
        <div className="shadow p-4 rounded-lg bg-white dark:bg-gray-900 	 ">
            ...
            <div className="transition-transform duration-500 transform ease-in-out hover:scale-110 w-full">
              <div className="absolute inset-0">
                <img
                  ...
                  } House in ${property && property.building_name}, ${
                    property && property.property_locality
                  }`}
                />
              </div>
            </div>
          ...
          <div className="mt-4">
            <h2
              ...
              title="New York"
            >
              {property.property_bhks} {property.property_type} House in{" "}
              {property.building_name}, {property.property_locality}
            </h2>
            <p
          ...
          <div className="grid grid-cols-2 grid-rows-2 gap-4 mt-8">
            <p className="inline-flex flex-col xl:flex-row xl:items-center text-gray-800">
              ...
              <span className="mt-2 xl:mt-0 dark:text-white">
                {property.property_bhks} {property.property_type}
              </span>
            </p>
            <p className="inline-flex flex-col xl:flex-row xl:items-center text-gray-800 ">
              <svg
          ...
          <div className="grid grid-cols-2 mt-8">
            ...
            <div className="flex justify-end">
              <p className="inline-block font-semibold text-primary whitespace-nowrap leading-tight rounded-xl">
                ...
                <span className="text-lg">{property.property_rent_price}</span>
                /m
              </p>
            </div>
          </div>
