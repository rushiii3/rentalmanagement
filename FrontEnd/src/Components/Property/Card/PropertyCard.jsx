    ...
    <div class="relative mx-auto w-full px-1">
      <Link class="relative inline-block duration-300 ease-in-out transition-transform transform hover:-translate-y-2 w-full ">
        <div class="shadow p-4 rounded-lg bg-white dark:bg-gray-900 	 ">
          ...
          <div class="mt-4">
            <h2
              class="font-medium text-base md:text-lg text-gray-800 line-clamp-1 dark:text-white"
              title="New York"
            >
              {property.property_bhk_type} House in {property.building_name}, {property.property_locality}
            </h2>
            <p
              class="mt-2 text-sm text-gray-800 line-clamp-1 dark:text-white"
              title="New York, NY 10004, United States"
            >
              {property.property_locality}, {property.property_city}, {property.property_state}
            </p>
          </div>
          ...
          <div class="grid grid-cols-2 grid-rows-2 gap-4 mt-8">
            <p class="inline-flex flex-col xl:flex-row xl:items-center text-gray-800">
              <svg
                class="inline-block w-5 h-5 xl:w-4 xl:h-4 mr-3 fill-current text-gray-800 dark:text-white"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 576 512"
              >
              ...
              <span class="mt-2 xl:mt-0 dark:text-white">{property.property_type}</span>
            </p>
            <p class="inline-flex flex-col xl:flex-row xl:items-center text-gray-800 ">
              <svg
                class="inline-block w-5 h-5 xl:w-4 xl:h-4 mr-3 fill-current text-gray-800 dark:text-white"
              ...
              <span class="mt-2 xl:mt-0 dark:text-white">{property.property_furnishing}</span>
            </p>
            <p class="inline-flex flex-col xl:flex-row xl:items-center text-gray-800">
              <svg
                class="inline-block w-5 h-5 xl:w-4 xl:h-4 mr-3 fill-current text-gray-800 dark:text-white"
              ...
              <span class="mt-2 xl:mt-0 dark:text-white">{property.property_size} sq. ft.</span>
            </p>
            ...
            <svg
              ...
              <span class="mt-2 xl:mt-0 dark:text-white">{property.property_parking}</span>
            </p>
          ...
          <div class="grid grid-cols-2 mt-8">
            <div class="flex items-center">
              <div class="relative">
              <Avatar src={property?.landlord?.url} name={property?.landlord?.firstname} size="sm" className="object-cover"/>
              ...
              <p class="ml-2 text-gray-800 line-clamp-1 dark:text-white">
            ...
            <div class="flex justify-end">
              <p class="inline-block font-semibold text-primary whitespace-nowrap leading-tight rounded-xl">
                ...
                <span class="text-lg">{property.property_rent_price}</span>/m
              </p>
            </div>
          </div>
        </div>
