                    ...
                    <ModalBody>
                      ...
                      >
                        {Landmarks?.map((value, key) => (
                            <AutocompleteItem key={key} textValue={value.property_locality}>
                              <div className="flex justify-between items-center">
                                <div className="flex gap-2 items-center">
                                  <FaLandmarkDome size={15} className="flex-shrink-0" />

                                  <div className="flex flex-col">
                                    <span className="text-medium">{value.property_locality}</span>
                                  </div>
                                </div>
                              </div>
                            </AutocompleteItem>
